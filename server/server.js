...
const FRONTEND_URL = process.env.FRONTEND_URL || "http://localhost:5173" || "http://business.hotncool.qa";

app.use(
  cors({
    origin: [FRONTEND_URL, "http://localhost:5173", "http://business.hotncool.qa", "http://127.0.0.1:5173"],
    methods: ["POST"],
  })
);
